...
4. За аналитичната част (Data Warehouse) може да се създаде отделна база/схема, в която да се реализират таблиците Dim/Fact и да се заредят чрез ETL процес от OLTP базата.
